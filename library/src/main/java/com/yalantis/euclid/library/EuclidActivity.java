...
public abstract class EuclidActivity extends AppCompatActivity {
    ...
    public static View mButtonProfile;
    ...
    private void addOverlayListItem(Map<String, Object> item, View view) {
        ...
        ((TextView) mOverlayListItemView.findViewById(R.id.text_view_description)).setText((Integer ) item.get(EuclidListAdapter.KEY_DESCRIPTION_SHORT));
