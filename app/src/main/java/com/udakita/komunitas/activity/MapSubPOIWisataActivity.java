...
public class MapSubPOIWisataActivity extends MyFunction implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //init progess dialog
        final ProgressDialog progress = new ProgressDialog(MapSubPOIWisataActivity.this);
        //tambahkan pesan
                    ...
                    try {
                        if (response.body().getDataKomunitas()!=null){
                            for (int i = 0; i < response.body().getDataKomunitas().size(); i++) {
                                ...
                                String placeName = response.body().getDataKomunitas().get(i).getNama();
                    ...
                    public void onInfoWindowClick(Marker marker) {
                        ...
                        for (Marker place : markersList) {
                            if (latLon.equals(place.getPosition())) {
                                ...
                                Intent intent = new Intent(MapSubPOIWisataActivity.this, DetailPOIActivity.class);
...
//                startActivity(in);
            ...
            case R.id.buttonMap:
                ...
                Intent intent = new Intent(MapSubPOIWisataActivity.this, SubPOIWisataActivity.class);
                // Pass all data population
