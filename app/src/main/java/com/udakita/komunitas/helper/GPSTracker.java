				...
				if (isGPSEnabled) {
					...
					if (checkPermission(context)) {
						...
						if (locationManager != null) {
							...
							if (location != null) {
								//HeroHelper.pesan(context,"Lokasi anda berdasarkan GPS");
					...
					if (location == null) {
						if (checkPermission(context)) {
							...
							if (locationManager != null) {
								...
								if (location != null) {
									//HeroHelper.pesan(context,"Lokasi anda berdasarkan BTS");
									latitude = location.getLatitude();
									longitude = location.getLongitude();
								}
...
//							HeroHelper.pesan(context, "Permission for GPS not valid");
	...
	public void showSettingGps() {
		...
		alertBuilder.setMessage("GPS is not enabled. Do you want to go to settings location ON ?");
